...
$controls[ 'animation_properties_info' ] = [
    ...
    'type'  => 'info', 
    'clearable' => true, 
    'content' => esc_html__( 'Choose from the available properties which can be animated.', 'ooohboi-kinekt' ),
    'required' => [
        [ 'animation_activate', '=', true ], 
        [ 'animation_type', '=', [ 'kinekt-fade-from-to', 'kinekt-text-effect' ] ], 
    ], 
...
$controls[ 'info_markers' ] = [
    ...
    'type'  => 'info', 
    'clearable' => true, 
    'content' => esc_html__( 'Markers are used to display visual indicators that represent the start and end positions of the scroll trigger.', 'ooohboi-kinekt' ),
    'required' => [
        [ 'animation_activate', '=', true ], 
        [ 'animation_type', '!=', '' ], 
    ], 
...
$controls[ 'info_scrub' ] = [
    ...
    'type'  => 'info', 
    'clearable' => true, 
    'content' => esc_html__( 'Scrubbing refers to the ability to control the progress of an animation based on the scroller position.', 'ooohboi-kinekt' ),
    'required' => [
        [ 'animation_activate', '=', true ], 
        [ 'animation_type', '!=', '' ], 
    ], 
...
$controls[ 'animation_type_use_scrub' ] = [
    'group'    => 'ooohboi_kinekt_controls', 
    'tab' => 'content', 
    'label'    => esc_html__( 'Use the Scrub?', 'ooohboi-kinekt' ), 
    'content' => esc_html__( 'Scrubbing refers to the ability to control the progress of an animation based on the scroller position.', 'ooohboi-kinekt' ),
    'type'     => 'checkbox',
    'inline'   => true,
    'small'    => true,
...
$controls[ 'info_pin' ] = [
    ...
    'type'  => 'info', 
    'clearable' => true, 
    'content' => esc_html__( 'Pinning makes the element stick in place while the scroll position is between the start and end elements/values.', 'ooohboi-kinekt' ),
    'required' => [
        [ 'animation_activate', '=', true ], 
        [ 'animation_type', '!=', '' ], 
    ], 
...
$controls[ 'animation_type_pin' ] = [
    'group'    => 'ooohboi_kinekt_controls', 
    'tab' => 'content', 
    'label'    => esc_html__( 'Pin this element?', 'ooohboi-kinekt' ), 
    'type'     => 'checkbox',
    'inline'   => true,
    'small'    => true,
    'default'  => false,
...
$controls[ 'info_transform_origin' ] = [
    ...
    'type'  => 'info', 
    'clearable' => true, 
    'content' => esc_html__( 'It defines the point around which a transformation is applied.', 'ooohboi-kinekt' ),
    'required' => [
        [ 'animation_activate', '=', true ], 
        [ 'animation_type', '=', [ 'kinekt-fade-from-to', 'kinekt-text-effect' ] ], 
    ], 
